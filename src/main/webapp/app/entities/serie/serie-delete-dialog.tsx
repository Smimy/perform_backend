...
export const SerieDeleteDialog = (props: ISerieDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="backEndApp.serie.delete.question">Are you sure you want to delete this Serie?</ModalBody>
      <ModalFooter>
        <Button color="secondary" onClick={handleClose}>
          <FontAwesomeIcon icon="ban" />
          &nbsp; Cancel
        </Button>
        <Button id="jhi-confirm-delete-serie" color="danger" onClick={confirmDelete}>
