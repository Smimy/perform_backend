...
import fr.perform.config.Constants;
import fr.perform.domain.User;
import fr.perform.repository.AuthorityRepository;
import fr.perform.repository.UserRepository;
import fr.perform.security.AuthoritiesConstants;
import fr.perform.service.UserService;
import fr.perform.service.dto.PasswordChangeDTO;
import fr.perform.service.dto.UserDTO;
import fr.perform.web.rest.vm.KeyAndPasswordVM;
import fr.perform.web.rest.vm.ManagedUserVM;
...
import static fr.perform.web.rest.AccountResourceIT.TEST_USER_LOGIN;
