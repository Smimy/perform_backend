...
import fr.perform.config.audit.AuditEventConverter;
import fr.perform.domain.PersistentAuditEvent;
...
import static fr.perform.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
